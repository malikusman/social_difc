...
import { LayoutDashboard, Inbox as InboxIcon, Users, BookOpen, Radio, Bot, Search, Bell, ChevronRight, LogOut } from 'lucide-react'
...
export default function App() {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-difc-sand">
      {/* ── Sidebar ── */}
      <aside className="w-[264px] shrink-0 bg-difc-blue-deep flex flex-col">
